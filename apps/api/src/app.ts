...
app.post('/api/profile/load-demo', (req: any, res) => {
  ...
  const demoContacts: CoachContact[] = [
    // D1 Power 4
    { id: nextContactId++, userId, school: 'Stanford', coachName: 'Jane Smith', coachEmail: 'jane.smith@stanford.edu', division: 'D1 Power 4', stage: 'Phone Call', verbalOffer: false, contactDate: new Date('2025-10-20'), createdAt: new Date('2025-10-20'), updatedAt: new Date('2025-12-01') },
    { id: nextContactId++, userId, school: 'UCLA', coachName: 'Mike Johnson', coachEmail: 'mike.johnson@ucla.edu', division: 'D1 Power 4', stage: 'Initial Contact', verbalOffer: false, contactDate: new Date('2025-11-15'), createdAt: new Date('2025-11-15'), updatedAt: new Date('2025-11-15') },
    { id: nextContactId++, userId, school: 'UNC', coachName: 'Sarah Williams', coachEmail: 'sarah.williams@unc.edu', division: 'D1 Power 4', stage: 'Reply Received', verbalOffer: false, contactDate: new Date('2025-10-01'), createdAt: new Date('2025-10-01'), updatedAt: new Date('2025-10-20') },
    { id: nextContactId++, userId, school: 'Virginia', coachName: 'Tom Brown', coachEmail: 'tom.brown@virginia.edu', division: 'D1 Power 4', stage: 'Official Visit', verbalOffer: false, contactDate: new Date('2025-09-15'), createdAt: new Date('2025-09-15'), updatedAt: new Date('2025-11-25') },
    // D1 Mid-Major
    { id: nextContactId++, userId, school: 'Santa Clara', coachName: 'Lisa Garcia', coachEmail: 'lisa.garcia@santaclara.edu', division: 'D1 Mid-Major', stage: 'Offer Extended', verbalOffer: true, contactDate: new Date('2025-08-20'), createdAt: new Date('2025-08-20'), updatedAt: new Date('2025-12-10') },
    { id: nextContactId++, userId, school: 'Gonzaga', coachName: 'David Lee', coachEmail: 'david.lee@gonzaga.edu', division: 'D1 Mid-Major', stage: 'Phone Call', verbalOffer: false, contactDate: new Date('2025-10-15'), createdAt: new Date('2025-10-15'), updatedAt: new Date('2025-11-20') },
    { id: nextContactId++, userId, school: 'BYU', coachName: 'Amy Chen', coachEmail: 'amy.chen@byu.edu', division: 'D1 Mid-Major', stage: 'Reply Received', verbalOffer: false, contactDate: new Date('2025-09-25'), createdAt: new Date('2025-09-25'), updatedAt: new Date('2025-10-30') },
    { id: nextContactId++, userId, school: 'University of San Diego', coachName: 'Carlos Rodriguez', coachEmail: 'carlos.rodriguez@sandiego.edu', division: 'D1 Mid-Major', stage: 'Offer Extended', verbalOffer: false, contactDate: new Date('2025-08-15'), createdAt: new Date('2025-08-15'), updatedAt: new Date('2025-12-05') },
    { id: nextContactId++, userId, school: 'Arizona State', coachName: 'Jennifer Davis', coachEmail: 'jennifer.davis@asu.edu', division: 'D1 Mid-Major', stage: 'Initial Contact', verbalOffer: false, contactDate: new Date('2025-11-01'), createdAt: new Date('2025-11-01'), updatedAt: new Date('2025-11-01') },
    { id: nextContactId++, userId, school: 'Washington', coachName: 'Mark Wilson', coachEmail: 'mark.wilson@washington.edu', division: 'D1 Mid-Major', stage: 'Phone Call', verbalOffer: false, contactDate: new Date('2025-10-10'), createdAt: new Date('2025-10-10'), updatedAt: new Date('2025-11-15') },
    // D2/D3
    { id: nextContactId++, userId, school: 'Middlebury', coachName: 'Emily Kemp', coachEmail: 'emily.kemp@middlebury.edu', division: 'D3', stage: 'Offer Extended', verbalOffer: false, contactDate: new Date('2025-07-20'), createdAt: new Date('2025-07-20'), updatedAt: new Date('2025-12-01') },
    { id: nextContactId++, userId, school: 'Bowdoin', coachName: 'Prof. Martinez', coachEmail: 'martinez@bowdoin.edu', division: 'D3', stage: 'Phone Call', verbalOffer: false, contactDate: new Date('2025-09-30'), createdAt: new Date('2025-09-30'), updatedAt: new Date('2025-11-10') },
    { id: nextContactId++, userId, school: 'Williams', coachName: 'Hannah Stone', coachEmail: 'hannah.stone@williams.edu', division: 'D3', stage: 'Official Visit', verbalOffer: false, contactDate: new Date('2025-10-05'), createdAt: new Date('2025-10-05'), updatedAt: new Date('2025-11-20') },
    { id: nextContactId++, userId, school: 'Amherst', coachName: 'Alex Johnson', coachEmail: 'alex.johnson@amherst.edu', division: 'D3', stage: 'Reply Received', verbalOffer: false, contactDate: new Date('2025-09-10'), createdAt: new Date('2025-09-10'), updatedAt: new Date('2025-10-15') },
    { id: nextContactId++, userId, school: 'Trinity', coachName: 'Robert Chang', coachEmail: 'robert.chang@trinity.edu', division: 'D3', stage: 'Initial Contact', verbalOffer: false, contactDate: new Date('2025-11-05'), createdAt: new Date('2025-11-05'), updatedAt: new Date('2025-11-05') },
  ];
